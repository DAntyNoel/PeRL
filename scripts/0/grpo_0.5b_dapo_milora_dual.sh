#!/bin/bash
#SBATCH --job-name=grpo-0.5b-dapo-milora-dual
...
CUDA_VISIBLE_DEVICES=0,1,2,3 ACCELERATE_LOG_LEVEL=info \
    ...
    --config.model.model_name_or_path "/home/fhshao/downloads/models/Qwen/Qwen2.5-0.5B" \
    --config.model.dtype "bfloat16" \
    --config.peft.use_peft true \
    --config.peft.type "milora_dual" \
    ...
    --config.dataset.dataset_name_or_path "/home/fhshao/PeRL/downloads/datasets/openr1/DAPO-Math-17k" \
